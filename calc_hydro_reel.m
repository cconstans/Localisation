...
clear MAT_s
filename=['C:\Users\CHARLOTTE\Documents\MATLAB\Bring\Data loc\' site '_filtOpt=' num2str(filterOption) '_c0=' num2str(c0)];
save(filename);
%%
...
Dx=max(X)-min(X);
Dy=max(Y)-min(Y);
title([site ' c_0=' num2str(c0) 'm/s D_x=' num2str(Dx,3) 'm D_y=' num2str(Dy,3) 'm'])
%%
