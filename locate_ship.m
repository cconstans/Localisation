%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Estimation de l'azimuth d'un bateau à partir des enregistrements des hydrophones sur
...
%% Paramètres
typeHL = 'LF';
AntenneCorrigee=1; % Beamforming avec l'antenne corrigées (positions des hydros calculées) ou circulaire.
DataSave=1;
bateau='MSCANGELA'; % Nom du bateau que l'on essaye de localise, repéré sur les données AIS.
arrID='CLD'; % Site considérée
